...
class RetireViewTest(DiscussionAPIViewTestMixin, ModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        self.hashed_username = get_retired_username_by_username(self.user.username)
        self.url = reverse(
    ...
    def test_basic(self):
        ...
        response = self.client.post(self.url, {'hashed_username': self.hashed_username}, **headers)
    ...
    def test_bad_hash(self):
        ...
        """
        headers = self.build_jwt_headers(self.superuser)
        response = self.client.post(self.url, {'hashed_username': "this will never match"}, **headers)
